...
mystruct *searchnodes(mystruct *tempRt,string english)
{
...
int main(void)
{
    ...
    {
    	 leaf= searchnodes(root,searchEnglish);
    	 ...
    	 if(i==leaf->currentNode) cout<<"no word founds\n";
            ...
            cout<<"number of node visited"<<numc<<" "<<endl;;
            cout<<"position of node"<<noden<<" "<<endl;;
    	 }
    	 cout<<"enter text to search: ";
